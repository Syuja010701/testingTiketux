...
@section('content')
    ...
    <div class=" d-grid gap-2 d-flex justify-content-between col-xl-8 mb-3">
        <a href="javascript:void(0)" id="createCoa" class="btn btn-primary"><iconify-icon  icon="ic:baseline-plus"></iconify-icon> Tambah Kategori</a>
  ...
  $(function () {
    ...
    var table = $('.data-table').DataTable({
        ...
        columns: [
            ...
            {data: 'kode', name:'kode'},
            {data: 'nama', name: 'nama'},
            {data: 'kategori_coa_id', name: 'kategoriCoa.nama'},
