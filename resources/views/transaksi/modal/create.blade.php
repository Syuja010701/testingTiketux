            ...
            <div class="modal-body">
                <form id="transaksi" name="transaksi" class="form-horizontal">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div class="col-sm-12">
                            <select class="form-select" aria-label="Default select example" name="kode_coa"
                                id="kode_coa" required>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div class="col-sm-12">
                            <input type="text" class="form-control" id="debit" value="{{ old('debit') }}"
                                name="debit" required="">
                            <div class="text-danger d-none" id="alert-kode_coa" role="alert"></div>
                        </div>
                    </div>
                    <div class="form-group mb-3">
                        ...
                        <div class="col-sm-12">
                            <input type="text" class="form-control" id="credit" value="{{ old('credit') }}"
                                name="credit" required="">
                            <div class="text-danger d-none" id="alert-kode_coa" role="alert"></div>
                        </div>
                    </div>
                    <div class="col-12 text-end">
                        <button type="button" class="btn btn-secondary btn-closed"
